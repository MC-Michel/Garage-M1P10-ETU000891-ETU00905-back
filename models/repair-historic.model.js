...
class RepairHistoric {
    static schema ={
        ...
        "exitInitDate": { type: 'date', validatorGetter: (paramPropertyName='exitInitDate')=> body(paramPropertyName).isISO8601().withMessage("Date de demande de sortie invalide").toDate() },
